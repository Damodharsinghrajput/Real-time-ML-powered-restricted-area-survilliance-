...
known_person1_image = face_recognition.load_image_file("Damodhar.jpg")
known_person2_image = face_recognition.load_image_file("Darshan.jpg")
known_person3_image = face_recognition.load_image_file("Dammu.jpg")
...
known_face_names.append("Damodhar")
known_face_names.append("Darshan")
